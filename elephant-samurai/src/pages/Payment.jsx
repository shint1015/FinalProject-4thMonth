...
export default function Payment() {
    ...
    const GotoDashboard = e => {
        ...
        navigate({
            to: '/confirm/$reservationId',
            params: { reservationId: updatedReservation.reservationId },
        })
    }
        ...
        <>
            ...
            <div className='my-[2.5rem] flex flex-col lg:flex-row px-[2rem] sm:px-[3rem] lg:px-[5rem] mb-30 gap-10 lg:gap-10 justify-between'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-4'>
                        ...
                        <div className='flex flex-col justify-between'>
                            ...
                            <div className='flex flex-row gap-2'>
                                ...
                                <div>
                                    <p className='text-body lg:text-detail text-primary-white'>
                                        Samarai Elephant Studio Theatre
                                    </p>
                            ...
                            <div className='flex flex-row justify-between items-center'>
                                <div className='flex flex-row items-center gap-1'>
                                    ...
                                    <p className='text-body lg:text-detail text-primary-white'>
                                        {' '}
                                        x {reservation.showTotalTicketAmount}
                                    </p>
                                </div>
                                <p className='text-body lg:text-detail text-primary-white'>
                                    ${reservation.showTotalPrice.toFixed(2)}
                                </p>
                            </div>
                            <div class='border-t border-primary-white my-4'></div>
                            ...
                            <div className='flex flex-row justify-between'>
                                ...
                                <p className='text-body lg:text-detail text-primary-yellow'>
                                    ${(reservation.showTotalPrice + reservation.showFee).toFixed(2)}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='lg:w-[1/2]'>
                    ...
                    <form className='flex flex-col justify-between gap-1' onSubmit={GotoDashboard}>
                        <div>
                        ...
                        <button
                            type='submit'
                            className='bg-primary-yellow text-black py-3 px-6 mt-4 rounded hover:bg-secondary-yellow text-subbody w-full'
                        >
                            Place Order
                        </button>
                    </form>
